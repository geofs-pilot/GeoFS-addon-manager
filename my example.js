  ...
  (function() {
	...
	//RUN ALL button segment
        const runAllButton = document.createElement('button');
	runAllButton.id = 'runAllButton';
	runAllButton.innerText = 'RUN ALL';
	runAllButton.style.position = 'absolute';
	runAllButton.style.right = '5px';
	runAllButton.style.top = '14px';
	
	runAllButton.onclick = () => {
	    runAllButton.innerText = 'RUNNING ALL';
	    runAllButton.style.backgroundColor = 'grey';
	    runAllButton.style.color = 'white';
	    runAllButton.style.border = '1px solid grey';
	    runAllButton.disabled = true;
	
	    // Find and click all individual addon run buttons
	    document.querySelectorAll('.addon-run-button').forEach(button => {
          ...
          function addAddon(name, runFunction) {
              ...
              const descriptions = {
     		  ...
     		  Toggle using [W]`,
                  ...
                  'LiverySelector (Use this if Realism pack is laggy)': `Unified livery handler addon for geofs.
 	      ...
 	      runButton.className = 'addon-run-button';
 	      ...
 	      addonListItem.appendChild(runAllButton, addonContent);
          }
          ...
          addAddon('LiverySelector (Use this if Realism pack is laggy)', ls);
